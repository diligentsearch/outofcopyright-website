...
$(function() {
	...
	$( "#downloadLanguage" ).click(function() {
		readFile(country, $("#languageToDownload").val()+'.json', function(dataTrad){
	...
	$("#readOnlyLanguage").click(function() {
		window.location.href = "?page_id=26&country="+country+"&language="+$("#chooseLanguageReadOnly").val()+"&readonly=true";
	});
...
function loadCountry(country){
	...
	readFile(country, country+'.json', function(data){
		...
		$("#edit-diagram").attr("href", "?page_id=26&country="+country+"&language="+file.default_language);
	...
	//Display changelog
	commits(country, country+'.json', function(data){
