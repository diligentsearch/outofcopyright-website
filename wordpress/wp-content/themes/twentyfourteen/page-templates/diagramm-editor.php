        ...
        <div class="row" id="leftPart" style="border-right: solid 3px #CFCFCF;">
            <div class="row" id="typeOfWorkRow" style="margin-top: 10px; margin-left: 5px; margin-right: 5px;">
                <div class="panel panel-primary">
                    <div class="panel-heading" style=" height: 42px; ">
                        <div class="col-sm-9">
                            <h6 class="panel-title row" style=" padding-top: 2px; ">Type of work</h6>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="panel-body" style="overflow-y: auto; overflow-x: hidden;min-width: 160px;" id="listTypeOfWorkRow">
            ...
            <div class="row" id="datapointsRow" style="margin-left: 5px; margin-right: 5px; ">
                <div class="panel panel-primary">
                    <div class="panel-heading" style=" height: 42px; ">
                        <div class="col-sm-9">
                            <h6 class="panel-title row" style=" padding-top: 2px; ">Datapoints</h6>
                        </div>
                        <div class="col-sm-3">
...
font-weight: bold;">
        ...
        <div class="panelProperty" id="formulaPanel" style="display:none;">
            ...
            <div class="row buttonPropertyActive">
                <select class="form-control buttonPropertyActive" id="datapointsFormula" style="border:none;background-color:#0072bc;">
        ...
        <div class="panelProperty" id="listPanel" style="display:none;">
            ...
            <div class="row buttonPropertyActive">
                <select class="form-control buttonPropertyActive" id="datapointsList" style="border:none;background-color:#0072bc;">
                    <option>Select datapoint</option>
                </select>
            </div>
            <div class="row buttonPropertyActive">
        ...
        <div class="panelProperty" id="aliasPanel" style="display:none;">
            ...
            <div class="row buttonPropertyActive responseToChangePart">
                <select class="form-control buttonPropertyActive" id="aliasResponse" style="border:none;background-color:#0072bc;">
            ...
            <div class="row buttonPropertyActive">
                <select class="form-control buttonPropertyActive" id="aliasNode" style="border:none;background-color:#0072bc;">
    ...
    <div id="buttonSave" class="col-sm-3" style="width: 20.7%;">
        <div class="row buttonPropertyActive text-center" style="font-size:28px;">
