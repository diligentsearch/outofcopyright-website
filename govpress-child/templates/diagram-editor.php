	...
	<div id="primary" class="content-area">
        ...
        <div class="col-sm-7" id='drawZone' style="height:100%;padding-left:0px;padding-right: 0px;">
            ...
            <div class="row" style="border-bottom: solid 1px #CFCFCF;border-right: solid 1px #000000;background-image: linear-gradient(to bottom, #ffffff, #f2f2f2);margin-left: 0px;">
                ...
                <div class="col-sm-1">
                    <i class="fa fa-print fa-2x grey-color" title="Print" style="margin-top: 15px;cursor:pointer;float: right;padding-right: 5px;" onclick="printDiagram();"></i>
                </div>
                <div class="col-sm-1">
                ...
                <div class="col-sm-1" style=" padding-top: 15px; padding-left: 0px; ">
                    <a href="#" class="popoverInfo" data-toggle="popover" title="Additional information" placement="bottom" data-content="By using this tool you agree that all your contributions will be released under <a href='https://creativecommons.org/licenses/by/4.0/'>Creative Commons Attribution 4.0 license</a>.">
